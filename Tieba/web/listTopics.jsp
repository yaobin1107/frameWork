...
<table cellspacing="0">
    ...
    <s:iterator value="#topicList" var="topic" status="st">
        <tr class="data">
            ...
            <td class="info">${topic.createDate}</td>
        </tr>
    </s:iterator>

    <tr>
        <td colspan="5" class="num">共有主题数<font color="red"></font>个</td>
    </tr>
    </tbody>
</table>
...
<!--发表主题表单-->
<form action="${pageContext.request.contextPath}/topic_save" class="addNewTopicForm">
