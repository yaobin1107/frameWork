...
//@Scope("prototype")
@Repository
public class UserDaoImpl_JdbcDaoSupport extends JdbcDaoSupport implements IUserDao {

    @Override
    public void add(User user) {
        System.out.println("Dao_添加用户" + user);
        super.getJdbcTemplate().update("insert into t_user (username,password) values (?,?)",
