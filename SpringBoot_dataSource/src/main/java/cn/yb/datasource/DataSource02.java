...
public class DataSource02 {
    ...
    public DataSource testDataSource(DBConfig2 testConfig) throws SQLException {
        ...
        xaDataSource.setUniqueResourceName("mybatis2DataSource");
    ...
    public SqlSessionFactory testSqlSessionFactory(@Qualifier("mybatis2DataSource") DataSource dataSource)
            throws Exception {
