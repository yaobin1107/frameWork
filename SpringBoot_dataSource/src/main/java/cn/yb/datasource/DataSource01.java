...
public class DataSource01 {
    ...
    public DataSource testDataSource(DBConfig1 testConfig) throws SQLException {
        ...
        xaDataSource.setUniqueResourceName("mybatis1DataSource");
    ...
    public SqlSessionFactory testSqlSessionFactory(@Qualifier("mybatis1DataSource") DataSource dataSource)
            throws Exception {
